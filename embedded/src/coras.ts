...
// so build()/parse() emit and read `/tickets/...` paths and the host's other
// routes (`/`, `/about`) are never mistaken for a Coras page. Locale and
// currency are fixed in config, so they stay out of the path.
